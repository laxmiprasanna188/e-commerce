...
const AddressForm = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto grid place-items-center p-10'>
      <div className='grid grid-cols-1 md:grid-cols-2 items-start gap-20 mt-10 max-w-7xl mx-auto'>
        
        {/* Left Side */}
        <div className='space-y-4 p-6 bg-white rounded-xl shadow-md w-full'>
            ...
            <>
              <div>
                ...
                <Input
                  ...
                  name='fullName'
                  required
                  placeholder='Laxmiprasanna Madam'
              ...
              <div>
                ...
                <Input
                  ...
                  name='email'
                  required
                  placeholder='laxmiprasanna@gmail.com'
